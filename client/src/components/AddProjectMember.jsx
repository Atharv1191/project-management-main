...
import { fetchWorkspaces } from "../features/workspaceSlice"; // make sure this exists
...
const AddProjectMember = ({ isDialogOpen, setIsDialogOpen }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post(
        // ✅ FIXED: route matches backend: '/:projectId/addMember'
      ...
      // Re-fetch workspaces so UI updates with new member
